...
!(function (global, factory) {
    ...
    Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.getInstance = exports.run = exports.Site = void 0);
                ...
                babelHelpers.createClass(Site, [
                    {
                        key: "initialize",
                        value: function () {
                            this.startLoading(), this.initializePluginAPIs(), this.initializePlugins(), this.initComponents(), this.setDefaultState();
                        },
                    },
                    {
                        key: "process",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var breakpoint = this.getCurrentBreakpoint(),
                                type = "open";
                            return $BODY.hasClass("site-menubar-keep") && $BODY.is(".site-menubar-keep") && (type = "hide"), "xs" === breakpoint && (type = "hide"), type;
                        },
                    },
                    {
                        key: "menubarType",
                    ...
                    },
                    {
                        key: "initComponents",
                        value: function () {
                            (this.menubar = new _Menubar2.default({ $el: (0, _jquery2.default)(".site-menubar") })), (this.sidebar = new _Sidebar2.default());
                            var $aside = (0, _jquery2.default)(".page-aside");
                            $aside.length > 0 && ((this.aside = new _PageAside2.default({ $el: $aside })), this.aside.run()), this.menubar.run(), this.sidebar.run();
                        },
                    },
                    {
                        key: "setDefaultState",
                    ...
                    },
                    {
                        key: "initBootstrap",
                        value: function () {
                            $DOC.tooltip({ selector: "[data-tooltip=true]", container: "body" }), (0, _jquery2.default)('[data-toggle="tooltip"]').tooltip(), (0, _jquery2.default)('[data-toggle="popover"]').popover();
                        },
                    },
                    {
                        key: "polyfillIEWidth",
                            ...
                            $DOC.on("click", ".navbar-mega .dropdown-menu", function (e) {
                                ...
                                .on("shown.bs.dropdown", function (e) {
                                    ...
                                    if ($menu.length > 0) {
                                        ...
                                        api ? api.update() : $menu.asScrollable({ namespace: "scrollable", contentSelector: "> [data-role='content']", containerSelector: "> [data-role='container']" });
                                    }
                                });
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            "undefined" != typeof Waves &&
                                (Waves.init(), Waves.attach(".site-menu-item > a", ["waves-classic"]), Waves.attach(".site-navbar .navbar-toolbar a", ["waves-light", "waves-round"]), Waves.attach(".btn", ["waves-classic"]));
                        },
                    },
                ]),
                Site
