...
.page-login-v2 .page-login-main form a {
  ...
  .login-left-img img {max-width: 100%; } 
  .login-left-v2 {height: 100vh; background: #FFF6F2;} 

  @media (max-width: 991.98px) { 
    .login-left-v2 .page-brand-info {margin: 80px 0px; max-width: calc(100% - 470px); }
  }
    ...
    <div class="page-content text-center login-left-v2">
      <div class="page-brand-info">
        <div class="login-left-img">
          ...
          {{-- <h2>DiverHub Days Login image</h2> --}}
        </div>
      </div>
      ...
      <div class="page-login-main form-horizontal">
        ...
        <h3 class="font-size-24">Sign In to start your session</h3>

        <form action="{{ route('adminlogin') }}" method="post" id="adminlogin">
         @csrf
         @if (session('error'))
       ...
       @endif  
         <div class="form-group row form-material text-left">
          ...
          <div class="form-group row form-material text-left">
            ...
            <div class=" col-xl-12">
              <div class="pass-toggle">
                <input type="password" class="form-control password-field empty @error('password') is-invalid @enderror" id="password" name="password" required autocomplete="current-password">
          ...
          <div class="form-group clearfix">
            ...
            <a class="float-right" href="{{ route('forgotpasswordform') }}">Forgot password?</a>
          </div>
          <button type="submit" class="btn btn-primary btn-block rotate-color-combo" id="kt_sign_in_submit">Login</button>
        </form>
