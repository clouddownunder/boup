    ...
    <div class="page-content text-center login-left-v2">
      <div class="page-brand-info">
        <div class="login-left-img">
          <img src="{{asset('images/Boup.png')}}" alt="{!!Config::get('constant.APP_NAME')!!}" alt="#">
        </div>
      </div>
      ...
      <div class="page-login-main form-horizontal">
       ...
       @endif         
          ...
          <div class="form-group clearfix">
            <a class="float-right" href="{{route('frontend.home')}}">Go to login</a>
          </div>
          <button type="submit" class="btn btn-primary btn-block rotate-color-combo" id="kt_sign_in_submit">Send Password Reset Link</button>
        </form>
