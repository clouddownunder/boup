  ...
  <div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content text-center login-left-v2">
      ...
      <div class="page-login-main form-horizontal">
        ...
        <form action="{{ route('adminResetPassword') }}" method="post" id="adminresetpassword">
         @csrf    
          ...
          <div class="form-group row form-material text-left">
            ...
            <div class=" col-xl-12">
              <div class="pass-toggle">
                <input class="form-control password-field empty @error('password') is-invalid @enderror" type="password" id="password" value="{{ old('password') }}" name="password" autocomplete="off" required/>
