...
<div class="page">
   <div class="page-header">
      <h1 class="page-title">{{ __('admin.pp-title') }}</h1>
    </div>
              ...
              <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="container-fuild mt-10 custom-section-class pb-30">
                    ...
                    <form method="post" action="{{ route('admin.ppsaveContent') }}" id="myform1">
                        @csrf
                        <div class="row">
                          <div class="col-md-12 mb-4">
                            <div class="form-outline">
                                <textarea type="text" id="editor" class="form-control form-control-lg" placeholder="Enter the privacy policy"  name="agreement" rows="5" >{{ $agreement->content ?? '' }}</textarea>
                            </div>
                          </div>
                        </div>
                        <div class="mt-2">
