                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <h2 style="color: #030303; font-size: 20px; margin: 0px 0px 20px; font-weight: 600;">Hello {{ $details['userName'] }},</h2>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        @if($details['action'] == 'deleted')
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">The Administrator has deleted your account. You won't be able to sign in to the Application. Please contact the Administrator for more information. </p>
                                                                                        @elseif($details['action'] == 'blocked')
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">The Administrator has blocked your account. You won't be able to sign in to the Application. Please contact the Administrator for more information. </p>
                                                                                        @elseif($details['action'] == 'suspended')
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">The Administrator has suspended your account. You won't be able to sign in to the Application for 30 days. Please contact the Administrator for more information. </p>
                                                                                        @elseif($details['action'] == 'active')
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">Your account is activated by Administrator. Now, you are able to login in to the Application. </p>
                                                                                        @endif
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text " align="left">
                                                                                        <p style="font-size: 16px;color: #6e7378; font-weight: 300; line-height: 24px;">Regards, <br />{{ config('app.name') }} Team </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td width="100%" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <p style="color: #A0A0A0; font-size: 14px; margin:0px; font-weight: normal;text-align: center;">© <?php echo date('Y'); ?> {{ config('app.name') }} | Australia</p>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
