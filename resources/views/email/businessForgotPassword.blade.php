                                                                        ...
                                                                        <table style="padding: 20px 0px;" width="100%" cellspacing="0" cellpadding="0" >
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    color:#000;line-height: 18px;"><br> Hello {{$businessname}}, </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="20"></td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button" align="center">
                                                                                        <span class="es-button-border" style="display: inline-block; padding: 20px 0px 30px;">
                                                                                            <a href="{{ Route('businessresetform',[$user])}}" style="color: #fff;text-decoration: none;background: #FF5221;width: 150px;height: 30px;display: inline-block;font-size: 15px;text-align: center;line-height: 30px;font-family: 'Roboto', sans-serif; display: table-cell;    vertical-align: middle;  ">
