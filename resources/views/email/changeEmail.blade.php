                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <h2 style="color: #030303; font-size: 20px; margin: 0px 0px 20px; font-weight: 600;">Hello {{ $userinfo->first_name }},</h2>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">Your email address has been successfully updated. If you did not request this change, please contact our support team immediately.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                {{-- <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;"><h1> {{ $userinfo->email }}</h1></p>
                                                                                    </td>
                                                                                </tr> --}}

                                                                                {{-- <tr>
                                                                                    <td class="esd-block-text " align="left">
                                                                                        <p style="font-size: 16px;color: #6e7378; font-weight: 300; line-height: 24px;">If you did not request to change your email, then simply ignore this email.</p>
                                                                                    </td>
                                                                                </tr> --}}

                                                                                <tr>
                                                                                    <td class="esd-block-text " align="left">
                                                                                        <p style="font-size: 16px;color: #6e7378; font-weight: 300; line-height: 24px;">Best regards, <br/>Boup Team </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
