                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <h2 style="color: #030303; font-size: 20px; margin: 0px 0px 20px; font-weight: 600;">Hello {{ $userinfo->name }},</h2>
                                                                                    </td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">Your password has been successfully updated. If you did not make this change, please contact our support team immediately.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                {{-- <tr>
                                                                                    <td class="esd-block-text  " align="left">
