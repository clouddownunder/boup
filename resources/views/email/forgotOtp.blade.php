            ...
            <tbody>
                <tr>
                    <td class="esd-email-paddings" valign="top">
                        <table cellpadding="0" cellspacing="0" class="es-content esd-header-popover" align="center" style="padding: 10px 0px;">
                            <tbody>
                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="center">
                                                                                        <h2 style="color: #030303; font-size: 24px; margin: 15px 0px 20px; font-weight: 500;">Your New Password </h2>
                                                                                    </td>
                                                                                </tr>
                                                                                {{-- <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">It seems like you changed your password. If this is correct, enter the below OTP to update your password.</p>
                                                                                    </td>
                                                                                </tr> --}}
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="center">
                                                                                        <h2 style="color: #030303; font-size: 20px; margin: 20px 0px; line-height: normal; font-weight: normal;">{{ $strdata }}</h2>
                                                                                    </td>
                                                                                </tr>
{{-- 
                                                                                <tr>
