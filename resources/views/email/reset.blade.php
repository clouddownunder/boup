...
.firebugRulerH {
    ...
    border-bottom: 1px solid #FF5221 !important;
...
.firebugRulerV {
    ...
    border-right: 1px solid #FF5221 !important;
...
<table class="container" align="center" border="0" cellpadding="0" cellspacing="0" width="600">
    <tbody>
    <tr bgcolor="{{Config::get('zauce.MAIL.HEADER_COLOR')}}"><td height="15"></td></tr>

    <tr bgcolor="{{Config::get('zauce.MAIL.HEADER_COLOR')}}">
        <td align="center">
            <table class="container-middle" align="center" border="0" cellpadding="0" cellspacing="0" width="560">
                <tbody><tr>
                    <td>
                        <table class="top-header-left" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody><tr>
                                <td align="center">
                                    <table class="date" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                        <tr>

                                            <td align="center" style="color: #000; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                <img  style="display: block;" src="{{ asset('images/logo.jpg') }}" alt="logo" width="200">
                                            </td>
                                        </tr>
                                        </tbody></table>
                                </td>
...
<tr>
    <td>
        <table class="container-middle" align="center" border="0" cellpadding="0" cellspacing="0" width="560" bgcolor="#FFFFFF">
            <tr>
                <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <table class="section-item" align="left" border="0" cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        <td  style="line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                            It seems like you forgot your password. If this is correct, click the link below to reset your password.
                                        </td>
                                    </tr>
                                    <tr><td height="15"></td></tr>
                                    <tr>
                                        <td  style="line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                            <a href="#" style=" font-family: Avenir,Helvetica,sans-serif;box-sizing: border-box; border-radius: 3px;color: {{Config::get('zauce.MAIL.THEME_FONT_COLOR')}};display: inline-block;text-decoration: none;background-color:{{Config::get('zauce.MAIL.THEME_COLOR')}};border-top: 10px solid {{Config::get('zauce.MAIL.THEME_COLOR')}};border-right: 18px solid {{Config::get('zauce.MAIL.THEME_COLOR')}};border-bottom: 10px solid {{Config::get('zauce.MAIL.THEME_COLOR')}};border-left: 18px solid {{Config::get('zauce.MAIL.THEME_COLOR')}}; padding:5px;" target="_blank">Reset My Password</a>
                                        </td>
                                    </tr>
                                    <tr><td height="15"></td></tr>
                                    <tr>
                                        <td  style="line-height: 25px; color: #484848; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                            <b>Note:</b> This link will expire in 15 minutes.
                                        </td>
                                    </tr>
                                    <tr><td height="15"></td></tr>
                                    <tr>
                                        <td  style="line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                            If you did not request to change your password, then simply ignore this email.
                                        </td>
                                    </tr>
                                    <tr><td height="15"></td></tr>
                                   <tr>
...
<table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
    <tbody>
    <tr bgcolor="{{Config::get('zauce.MAIL.THEME_COLOR')}}"><td height="15"></td></tr>
    <tr bgcolor="{{Config::get('zauce.MAIL.THEME_COLOR')}}">
        <td  style="color: {{Config::get('zauce.MAIL.THEME_FONT_COLOR')}}; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
            Copyright © <?php echo date('Y'); ?> {{Config::get('zauce.REPLAY_NAME')}} - All Rights Reserved.
        </td>
    </tr>

    <tr>
        <td bgcolor="{{Config::get('zauce.MAIL.THEME_COLOR')}}" height="14"></td>
    </tr>
    </tbody></table>
<!-- end footer-->
</td>
