                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button" align="center">
                                                                                        <span class="es-button-border" style="display: inline-block; padding: 20px 0px 30px;">
                                                                                            <a href="{{ Route('vendorShowResetPasswordForm',[$token])}}" style="color: #fff;text-decoration: none;background: #FF5221;width: 150px;height: 30px;display: inline-block;font-size: 15px;text-align: center;line-height: 30px;font-family: 'Roboto', sans-serif; display: table-cell;    vertical-align: middle;  ">
