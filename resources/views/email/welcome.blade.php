                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table style="padding: 2px 0px;" width="100%" cellspacing="0" cellpadding="0" >
                                                                            <tbody>
                                                                                <!-- <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <h2 style="color: #030303; font-size: 20px; margin: 0px 0px 20px; font-weight: 600;">Welcome!</h2>
                                                                                    </td>
                                                                                </tr> --> 

                                                                            <?php if($post['for_user_type'] !='family'){ ?>
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <h4 style="color: #030303; font-size: 18px; margin: 0px 0px 20px;">
                                                                                            <?php if($post['for_user_type'] =='teacher'){ ?>Dear <?php } ?>{{ucwords($post['userName'])}},</h4>
                                                                                    </td>
                                                                                </tr> 
                                                                             <?php } ?>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;"> We’re super excited to have you join our platform.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text  " align="left">
                                                                                        <p style="font-size: 16px; color: #6e7378; font-weight: 300; line-height: 24px;">
                                                                                        Regards,<br>
                                                                                        Boup Team
                                                                                         </p>
                                                                                    </td>
