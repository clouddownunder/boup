...
<head>
  ...
  <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .thank-you-page-content h1{position: relative; width: 100%; margin-bottom: 0px; padding-top: 15px; font-size: 30px; font-weight: 200; line-height: 40px;}
...
<body>
  <div class="container">
    <div class="card thank-you-page-content">
      <a href="#" class="logo"><img src="{{ asset('images/login.png') }}" alt="#"> </a>
      <!-- <div class="icon">&#10003;</div> -->
      <h1>Thank you, Your password has been updated now, you can login into your app.</h1>
      {{-- <a  class="btn">Go back to App</a> --}}
    </div>
    <footer>
     
      <div class="copyright">
        <strong>Copyright &copy; <?php echo date('Y');?> <a href="https://www.boupapp.com/">{{ config('app.name', 'Laravel') }}</a>.</strong> All rights reserved.
